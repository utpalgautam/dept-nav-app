    ...
    return Positioned(
      ...
      child: FadeTransition(
        ...
        child: ScaleTransition(
          ...
          child: Icon(Icons.star, color: Colors.grey.shade300, size: size),
        ),
      ),
    );
  }
                          ...
                          children: [
                            ...
                            Stack(
                              ...
                              children: [
                                ...
                                _buildWindLine(
                                    screenHeight * 0.3 * 0.30, 100, 80, false),
                                _buildWindLine(
                                    screenHeight * 0.3 * 0.45, 200, 50, true),
                                _buildWindLine(
                                    screenHeight * 0.3 * 0.60, 50, 100, false),
                                _buildWindLine(
